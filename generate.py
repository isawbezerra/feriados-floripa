...
ELECTION_ROUNDS: dict[int, tuple[date, date]] = {
    ...
    # 2028: (date(2028, ??, ??), date(2028, ??, ??)),  # municipais — TBD
    # 2030: (date(2030, ??, ??), date(2030, ??, ??)),  # gerais — TBD
}

WORLD_CUP_PERIODS: dict[int, tuple[date, date]] = {
    # Source: FIFA — Canada/Mexico/USA 2026
    2026: (date(2026, 6, 11), date(2026, 7, 19)),
    # 2030: (date(2030, ??, ??), date(2030, ??, ??)),  # TBD
}
